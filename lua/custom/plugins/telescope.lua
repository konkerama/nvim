-- CUSTOM: Authoritative telescope config and spec. Lives here (not init.lua) so all of
-- telescope's setup is in one place. Sections marked CUSTOM are additions on top of the
...
return {
	...
	config = function()
		...
		vim.keymap.set("n", "<leader><leader>", function()
			builtin.buffers({ sort_mru = true, sort_lastused = true, select_current = false })
